export const helpBootNotification = {
  ...
  iccid: {
    type: "String[20]",
    description:
      "Optional. This contains the ICCID ( Integrated Circuit Card Identification Number ) of the modem’s SIM card.",
  },

  imsi: {
    type: "String[20]",
    description:
      "Optional. This contains the IMSI ( International mobile subscriber identity ) of the modem’s SIM card.",
  },
