      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={6}>
          <Button
            ...
            variant="contained"
            disabled={
              settings.inTransaction || status.status !== mainStatus.authorized
            }
        ...
        <Grid item xs={6}>
          <FormControl fullWidth>
            ...
            >
              {Object.keys(stopReason).map((x) => (
                <MenuItem key={x} value={stopReason[x]}>
                  {stopReason[x]}
                </MenuItem>
              ))}
            </Select>
        ...
        <Grid item xs={6}>
          <FormControl fullWidth>
            ...
            >
              {Object.keys(connectorStatus).map((x) => (
                <MenuItem key={x} value={connectorStatus[x]}>
        ...
        <Grid item xs={6}>
          <Button
            fullWidth
            variant="contained"
            onClick={() => sendRequest("StatusNotification")}
          >
            status notification
          </Button>
        </Grid>
        ...
        <Grid item xs={6}>
          <FormGroup row>
            ...
            <StyledButton
              ...
              startIcon={<AddIcon />}
              onClick={() =>
                updateData("currentMeterValue", settings.currentMeterValue + 10)
              }
            />
          </FormGroup>
        </Grid>
